...
d3.csv(data_file, function(error, data) {
  ...
  y.domain([0, 8])
    ...
    // set the gradient
  svg2_0.append("linearGradient")
    .attr("id", gradient_id2)
  ...
  svg2_0.selectAll("dot")
      .data(data)
    .enter().append("circle")
      .attr("fill", "url(#" + gradient_id2 + ")")
      .attr("r", 6)
