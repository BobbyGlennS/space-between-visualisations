...
d3.csv(data_file, function(error, data) {
  ...
  x.domain([parseTime("00:00"), parseTime("05:03")]);
  y.domain([0, 8])

  // set the gradient for mean line
  svg3_1.append("linearGradient")
    .attr("id", gradient_id3_0)
  ...
  svg3_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id3_0 + ")")
  ...
  svg3_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id3_1 + ")")
  ...
  svg3_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id3_2 + ")")
    .attr("stroke-width", "5px")
    .style("opacity", 0.2)
    .attr("d", rater_line2)
    .on("mouseenter", function() {
  ...
  //     });
      ...
      svg3_1.append("path")
        .data([data])
        .attr("fill", "none")
        .style("stroke", "url(#" + gradient_id3_3 + ")")
        .attr("stroke-width", "5px")
        .style("opacity", 0.2)
        .attr("d", rater_line3)
        .on("mouseenter", function() {
