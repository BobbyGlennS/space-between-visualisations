...
d3.csv(data_file, function(error, data) {
  ...
  svg4_1.append("linearGradient")
    .attr("id", gradient_id4_0)
  ...
  svg4_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id4_0 + ")")
  ...
  svg4_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id4_1 + ")")
  ...
  svg4_1.append("path")
    .data([data])
    .attr("fill", "none")
    .style("stroke", "url(#" + gradient_id4_2 + ")")
    .attr("stroke-width", "5px")
    .style("opacity", 0.2)
    .attr("d", rater_line2)
    .on("mouseenter", function() {
  ...
  //     });
      ...
      svg4_1.append("path")
        .data([data])
        .attr("fill", "none")
        .style("stroke", "url(#" + gradient_id4_3 + ")")
        .attr("stroke-width", "5px")
        .style("opacity", 0.2)
        .attr("d", rater_line3)
        .on("mouseenter", function() {
